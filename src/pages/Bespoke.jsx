...
export default function Bespoke() {
  return (
    <div className="pt-32 pb-24 px-6 md:px-12 max-w-[1400px] mx-auto min-h-screen">
      {/* Background blend styling handled by body class in original, applying locally */}
      <div 
        className="fixed inset-0 pointer-events-none -z-10 bg-[#faf9f5] mix-blend-multiply opacity-50"
        style={{ backgroundImage: 'url(https://lh3.googleusercontent.com/aida-public/AB6AXuBYsdxHj27BUyrJSIf18JhnU0YDATPRqs4zn3hKmvPWiTUkqIagNJWyvWJ_oMjG6TK_8RD8L_PRLIMayVE8wgkmVY5hvbItE3XfScYmwFk5LzCCk7Yugdu1KEIZo2-1xgIyxVSQkAYHQQmZ5smFeD2KihQsgsonb7JHLFSGpUfP7XypMwBmbPKguOA_DtEIb4vu4JIquX1DdnS5nuzPzjFYs3IXk584yAk44iunQWZavNxMpF-ZbSxBUO0iK2iRuw2z2QIZTAkJ5v8a)' }}
      />
      
      {/* Hero Section */}
      <header className="text-center mb-24 relative z-10">
        <h1 className="font-headline text-4xl md:text-6xl tracking-[0.1em] text-primary mb-6">An Invitation to the Atelier</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        ...
        <section className="lg:col-span-7 bg-surface-container-lowest p-10 md:p-16 border border-outline-variant/15 relative overflow-hidden">
          {/* Subtle Emerald Gradient Overlay Mimicking Silk */}
      ...
      <section className="mt-32 relative z-10 w-full overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-0 ml-[-24px] md:ml-[-48px] w-[calc(100%+48px)] md:w-[calc(100%+96px)] max-w-none">
          ...
          {/* Hyderabad (Light) */}
          <div className="bg-[#f0eee9] p-12 lg:p-16 group relative overflow-hidden transition-all duration-700 min-h-[420px] flex flex-col justify-between border-r border-[#003527]/5">
            ...
            <div className="absolute inset-0 bg-[#003527]/80 opacity-0 group-hover:opacity-100 transition-opacity duration-700 z-0"></div>
            
            <div className="relative z-10 flex flex-col h-full transform group-hover:-translate-y-2 transition-transform duration-700">
              <div>
                <span className="font-label text-[10px] uppercase tracking-[0.2em] text-[#755b00] group-hover:text-[#ffe08f] transition-colors duration-700">South India</span>
                <h4 className="font-headline text-3xl text-[#003527] group-hover:text-[#faf9f5] transition-colors duration-700 mt-3">Hyderabad</h4>
                <p className="font-body text-[#003527]/70 group-hover:text-[#faf9f5]/80 transition-colors duration-700 mt-6 leading-relaxed max-w-[240px]">
                  Banjara Hills, Hyderabad. Where the Nizami heritage embraces our silk craftsmanship.
                </p>
              </div>
            </div>
            <div className="relative z-10 mt-12">
              <span className="inline-flex items-center gap-3 font-label text-[9px] uppercase tracking-[0.3em] text-[#755b00] border-b border-[#755b00]/30 pb-1 group-hover:text-[#faf9f5] group-hover:border-[#faf9f5]/50 transition-all duration-700 cursor-pointer">
                View Map
              </span>
            </div>
          </div>
          ...
          {/* London (Dark) */}
          <div className="bg-[#003527] p-12 lg:p-16 group relative overflow-hidden transition-all duration-700 min-h-[420px] flex flex-col justify-between border-r border-[#faf9f5]/5">
            ...
            <div className="relative z-10 flex flex-col h-full transform group-hover:-translate-y-2 transition-transform duration-700">
              <div>
                <span className="font-label text-[10px] uppercase tracking-[0.2em] text-[#ffe08f] transition-colors duration-700">United Kingdom</span>
                <h4 className="font-headline text-3xl text-[#faf9f5] transition-colors duration-700 mt-3">London</h4>
                <p className="font-body text-[#faf9f5]/70 group-hover:text-[#faf9f5]/90 transition-colors duration-700 mt-6 leading-relaxed max-w-[240px]">
                  Mount Street, Mayfair. Where heritage meets modern British elegance.
                </p>
              </div>
            </div>
            <div className="relative z-10 mt-12">
              <span className="inline-flex items-center gap-3 font-label text-[9px] uppercase tracking-[0.3em] text-[#ffe08f] border-b border-[#ffe08f]/30 pb-1 group-hover:text-[#faf9f5] group-hover:border-[#faf9f5]/50 transition-all duration-700 cursor-pointer">
                View Map
              </span>
            </div>
          </div>
          ...
          <div className="bg-[#f0eee9] p-12 lg:p-16 group relative overflow-hidden transition-all duration-700 min-h-[420px] flex flex-col justify-between border-r border-[#003527]/5">
            ...
            <div className="relative z-10 flex flex-col h-full transform group-hover:-translate-y-2 transition-transform duration-700">
              <div>
                <span className="font-label text-[10px] uppercase tracking-[0.2em] text-[#755b00] group-hover:text-[#ffe08f] transition-colors duration-700">North India</span>
                <h4 className="font-headline text-3xl text-[#003527] group-hover:text-[#faf9f5] transition-colors duration-700 mt-3">New Delhi</h4>
                <p className="font-body text-[#003527]/70 group-hover:text-[#faf9f5]/80 transition-colors duration-700 mt-6 leading-relaxed max-w-[240px]">
          ...
          {/* New York (Dark) */}
          <div className="bg-[#003527] p-12 lg:p-16 group relative overflow-hidden transition-all duration-700 min-h-[420px] flex flex-col justify-between">
            ...
            <div className="relative z-10 flex flex-col h-full transform group-hover:-translate-y-2 transition-transform duration-700">
              <div>
                <span className="font-label text-[10px] uppercase tracking-[0.2em] text-[#ffe08f] transition-colors duration-700">United States</span>
                <h4 className="font-headline text-3xl text-[#faf9f5] transition-colors duration-700 mt-3">New York</h4>
                <p className="font-body text-[#faf9f5]/70 group-hover:text-[#faf9f5]/90 transition-colors duration-700 mt-6 leading-relaxed max-w-[240px]">
        ...
        <div className="h-[300px] bg-primary relative overflow-hidden ml-[-24px] md:ml-[-48px] w-[calc(100%+48px)] md:w-[calc(100%+96px)] max-w-none border-t border-[#faf9f5]/10">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="relative w-full h-full max-w-5xl mx-auto">
              <div className="absolute top-1/3 left-[20%] w-2 h-2 bg-[#755b00] rounded-full ring-4 ring-[#755b00]/20 shadow-[0_0_15px_#755b00]"></div>
              <div className="absolute top-1/4 left-[45%] w-2 h-2 bg-[#755b00] rounded-full ring-4 ring-[#755b00]/20 shadow-[0_0_15px_#755b00]"></div>
              <div className="absolute top-1/2 right-[30%] w-2 h-2 bg-[#755b00] rounded-full ring-4 ring-[#755b00]/20 shadow-[0_0_15px_#755b00]"></div>
              <div className="absolute top-[55%] right-[25%] w-2 h-2 bg-[#755b00] rounded-full ring-4 ring-[#755b00]/20 shadow-[0_0_15px_#755b00]"></div>
              
              <svg className="absolute inset-0 w-full h-full stroke-[#755b00]/20 fill-transparent pointer-events-none" viewBox="0 0 1000 300">
          ...
          <div className="absolute bottom-8 right-12 flex items-center gap-3">
            <span className="material-symbols-outlined text-[#755b00] text-lg">public</span>
            <span className="font-label text-[10px] tracking-[0.4em] uppercase text-[#faf9f5]/50">Global Logistics Hubs</span>
          </div>
        </div>
      </section>
    </div>
