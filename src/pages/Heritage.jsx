export default function Heritage() {
  return (
    <div className="w-full bg-surface">
      ...
      {/* The Story Rail */}
      <section className="py-24 md:py-32 silk-gradient text-on-primary relative overflow-hidden">
        <div className="pointer-events-none absolute -top-40 right-0 w-[500px] h-[500px] rounded-full opacity-20 blur-3xl" style={{ background: 'radial-gradient(circle, #d29a9e 0%, transparent 70%)' }}></div>
        <div className="px-6 md:px-8 max-w-[1920px] mx-auto mb-16 md:mb-24 relative z-10">
          <span className="font-label text-[10px] tracking-[0.4em] uppercase text-[#e8c887] mb-6 block">A Philosophy</span>
          <h2 className="font-display italic text-4xl md:text-7xl text-[#d29a9e]">The Architectural <br/> Restraint</h2>
        </div>
        
        {/* Horizontal scroll container (Story Rail) */}
        <div className="relative z-10 flex overflow-x-auto gap-8 md:gap-16 px-6 md:px-8 max-w-[1920px] mx-auto pb-16 no-scrollbar snap-x snap-mandatory">
          {[
            {
              title: "Ivory & Rose",
              desc: "A dialogue between the warmth of unbleached silk and the hush of blush-pink dusk.",
            ...
            <div key={i} className="min-w-[85vw] md:min-w-[700px] flex flex-col md:flex-row gap-6 md:gap-12 items-center bg-[#321923] p-6 md:p-12 snap-center gild-border relative overflow-hidden group">
              ...
              <div className="w-full md:w-1/2 p-2 md:p-6 flex flex-col justify-center">
                <span className="font-label text-[9px] md:text-[10px] tracking-[0.3em] text-[#e8c887] uppercase block mb-3 md:mb-5">Chapter 0{i+1}</span>
                <h3 className="font-display italic text-3xl md:text-4xl mb-4 md:mb-6 text-[#fbf4f1] leading-tight">{item.title}</h3>
                <p className="font-body text-base md:text-lg text-[#fbf4f1]/75 leading-relaxed md:leading-[1.8]">{item.desc}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 text-left">
          <div className="group flex flex-col items-center">
            <div className="w-full aspect-[3/4] overflow-hidden mb-8 relative ghost-border">
              <div className="absolute inset-0 bg-[#3d1f2a]/15 group-hover:bg-transparent transition-colors duration-700 z-10"></div>
              <img 
          ...
          <div className="group flex flex-col items-center">
            ...
            <div className="w-full px-4 text-center">
              ...
              <p className="font-body text-primary/70 leading-relaxed max-w-sm mx-auto">
                We never use absolute black. Deep Plum acts as the ink for all typographic weight, providing warmth and quiet regal authority.
              </p>
            </div>
          </div>
        </div>
